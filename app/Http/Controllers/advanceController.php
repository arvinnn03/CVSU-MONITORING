...
class AdvanceController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            // Initialize the query with a join on the 'users' table
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function($row) {
                    ...
                    $viewBtn = '<a href="/visitor/view/' . $row->id . '" class="btn btn-outline-dark btn-sm mx-1" title="View" data-toggle="tooltip" data-placement="top"><i class="bi bi-eye"></i></a>';
    ...
    $validatedData = $request->validate([
        ...
        'visitor_enter_by' => 'nullable|string',
    ]);
    ...
    return redirect()->route('advance.print', $visitor->id)
    ...
    public function print($id)
    {
        ...
        return view('print_advance', compact('data'));
    }
...
public function verifyToken(Request $request)
{
    ...
    if ($visitor->visitor_status === 'In') {
        ...
        // Don't change the out time when checking in
    ...
    return response()->json([
        ...
        'visitor_out_time' => $visitor->visitor_out_time ? Carbon::parse($visitor->visitor_out_time)->timezone('Asia/Manila')->format('m/d/Y h:i A') : null,
